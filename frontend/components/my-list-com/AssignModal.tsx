      ...
      >
        ...
        >
          <div className="flex justify-between items-center mb-5 pb-3 border-b border-neutral-100 dark:border-zinc-800/80">
            ...
            <button onClick={onClose} className="p-1 hover:bg-neutral-100 dark:hover:bg-zinc-800 rounded-full transition-colors text-neutral-400 dark:text-zinc-555 hover:text-neutral-600 dark:hover:text-zinc-300">
              <X size={18} />
            </button>
          </div>
          ...
          <div className="mt-5 border-t border-neutral-100 dark:border-zinc-800/80 pt-4">
            <p className="text-xs font-semibold text-neutral-500 dark:text-zinc-450 uppercase tracking-wider mb-2">
              {assigned.length} user(s) assigned
            </p>
            {assigned.length === 0 ? (
              <p className="text-xs text-neutral-450 dark:text-zinc-500 italic">No doers assigned yet. Select one above.</p>
            ) : (
